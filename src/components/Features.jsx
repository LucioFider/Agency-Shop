  ...
  return (
    <section class="method" id="method">
      ...
      <div class="method-header">
        <p class="text-small accent3">A Proven Focus</p>
        <h2>Teaching Method</h2>
        <p>
          Over the last fifteen years, I’ve developed a set of teaching methods
          that energize students, promote creativity, and encourage excellence.
        </p>
      </div>
      <div class="cards">
